...
def step1():
    print("step1")
    global indicator1
    indicator1 = IndicatorManager.create(APPINDICATOR_ID, "audio-headphones", AppIndicator3.IndicatorCategory.HARDWARE)
...
def step2():
    ...
    global indicator1
    # del indicator1
    IndicatorManager.destroy(APPINDICATOR_ID)
    # GLib.idle_add(step3)
...
def step3():
    print("step3")
    global indicator2
    indicator2 = IndicatorManager.create(APPINDICATOR_ID, "audio-headphones", AppIndicator3.IndicatorCategory.HARDWARE)
